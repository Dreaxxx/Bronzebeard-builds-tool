  ...
  return (
    <Card>
      <div className="space-y-4">
        ...
        <div><Label>{t('common.tiers')}</Label><Input value={tiersStr} onChange={e=>setTiersStr(e.target.value)} /><p className="text-xs text-neutral-500 mt-1">Ex: PreBiS,M0,M+&lt;10,M+10-14,M+15+</p></div>
